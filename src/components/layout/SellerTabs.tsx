...
import { LayoutDashboard, ShoppingBag, PlusSquare } from "lucide-react";
import { cn } from "@/lib/utils";

const tabs = [
  { to: "/seller/dashboard", label: "Dashboard", icon: LayoutDashboard },
  { to: "/sell", label: "Publicar", icon: PlusSquare, primary: true },
  { to: "/seller/orders", label: "Ventas", icon: ShoppingBag },
];
