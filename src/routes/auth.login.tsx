...
function LoginPage() {
  ...
  return (
    <div className="app-shell flex min-h-dvh flex-col px-6 pt-14 safe-top">
      ...
      <p className="mt-1 text-sm text-muted-foreground">Reventa premium verificada en Chile.</p>
      ...
      <form onSubmit={handleLogin} className="mt-8 space-y-3">
        ...
        <button
          ...
          className="w-full rounded-full border border-border py-3.5 text-sm font-semibold flex items-center justify-center gap-2"
        >
        ...
        <div className="text-center">
          <Link to="/auth/login" className="text-sm text-trust">¿Olvidaste tu contraseña?</Link>
        </div>
      </form>
