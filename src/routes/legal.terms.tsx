...
export const Route = createFileRoute("/legal/terms")({ head: () => ({ meta: [{ title: "Términos — Trueki" }] }), component: TermsPage });
function TermsPage() { return <LegalPage title="Términos y condiciones" updated="16 de mayo 2026"><p>Trueki opera como intermediario verificado de reventa premium en Chile. Al usar la plataforma aceptas las siguientes condiciones.</p><h2>1. Sobre la verificación</h2><p>Todo artículo vendido en Trueki pasa por nuestro centro de autenticación en Santiago antes de ser entregado al comprador. Trueki se reserva el derecho de rechazar artículos que no cumplan los estándares de autenticidad.</p><h2>2. Pagos y escrow</h2><p>El pago del comprador queda retenido hasta que el artículo pase verificación y sea entregado. Solo entonces se libera el pago al vendedor. En caso de artículo falso o no conforme, se reembolsa al comprador.</p><h2>3. Comisiones</h2><p>Trueki cobra un 12% de comisión al vendedor y un 5% de protección al comprador sobre el precio del artículo. El envío inbound es responsabilidad del vendedor. El envío outbound está incluido.</p><h2>4. Strikes y bans</h2><p>Vender artículos falsos resulta en strike inmediato. Tres strikes equivalen a ban permanente de la plataforma. Trueki puede denunciar actividad fraudulenta a las autoridades.</p><h2>5. Ley aplicable</h2><p>Este acuerdo se rige por las leyes de la República de Chile. Los conflictos se resolverán en los tribunales de Santiago.</p></LegalPage>; }
