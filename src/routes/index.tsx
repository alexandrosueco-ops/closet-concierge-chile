  ...
  return (
    <div className="app-shell pb-24">
      ...
      <section className="mx-4 mt-4 overflow-hidden rounded-3xl bg-primary p-5">
        ...
        <Link to="/search" className="mt-4 inline-flex items-center gap-1.5 rounded-full bg-foreground px-4 py-2 text-xs font-bold text-background active:scale-95 transition-all">
      ...
      <section className="mt-5 px-4">
        ...
        {loading ? (
          ...
          <div className="rounded-2xl border-2 border-dashed border-border p-10 text-center">
            <p className="text-sm font-bold">Aún no hay publicaciones</p>
            <p className="mt-1 text-xs text-muted-foreground">¡Sé el primero en publicar!</p>
            <Link to="/sell" className="mt-3 inline-flex rounded-full bg-primary px-5 py-2 text-xs font-black">Publicar ahora</Link>
          </div>
        ) : (
